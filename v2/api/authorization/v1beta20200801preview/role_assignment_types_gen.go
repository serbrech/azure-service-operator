...
func (assignment *RoleAssignment) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20200801ps.RoleAssignment
...
func (assignment *RoleAssignment) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20200801ps.RoleAssignment
...
func (assignment *RoleAssignment) AssignProperties_From_RoleAssignment(source *v1beta20200801ps.RoleAssignment) error {
...
func (assignment *RoleAssignment) AssignProperties_To_RoleAssignment(destination *v1beta20200801ps.RoleAssignment) error {

	// ObjectMeta
	destination.ObjectMeta = *assignment.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20200801ps.RoleAssignment_Spec
	...
	// Status
	var status v1beta20200801ps.RoleAssignment_STATUS
...
func (assignment *RoleAssignment_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20200801ps.RoleAssignment_Spec)
	if ok {
	...
	src = &v1beta20200801ps.RoleAssignment_Spec{}
...
func (assignment *RoleAssignment_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20200801ps.RoleAssignment_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20200801ps.RoleAssignment_Spec{}
...
func (assignment *RoleAssignment_Spec) AssignProperties_From_RoleAssignment_Spec(source *v1beta20200801ps.RoleAssignment_Spec) error {
...
func (assignment *RoleAssignment_Spec) AssignProperties_To_RoleAssignment_Spec(destination *v1beta20200801ps.RoleAssignment_Spec) error {
...
func (assignment *RoleAssignment_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20200801ps.RoleAssignment_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20200801ps.RoleAssignment_STATUS{}
...
func (assignment *RoleAssignment_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20200801ps.RoleAssignment_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20200801ps.RoleAssignment_STATUS{}
...
func (assignment *RoleAssignment_STATUS) AssignProperties_From_RoleAssignment_STATUS(source *v1beta20200801ps.RoleAssignment_STATUS) error {
...
func (assignment *RoleAssignment_STATUS) AssignProperties_To_RoleAssignment_STATUS(destination *v1beta20200801ps.RoleAssignment_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
