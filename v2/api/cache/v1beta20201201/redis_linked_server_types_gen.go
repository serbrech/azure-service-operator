...
import (
	"fmt"
	v1beta20201201s "github.com/Azure/azure-service-operator/v2/api/cache/v1beta20201201/storage"
...
func (server *RedisLinkedServer) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20201201s.RedisLinkedServer
...
func (server *RedisLinkedServer) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20201201s.RedisLinkedServer
...
func (server *RedisLinkedServer) AssignProperties_From_RedisLinkedServer(source *v1beta20201201s.RedisLinkedServer) error {
...
func (server *RedisLinkedServer) AssignProperties_To_RedisLinkedServer(destination *v1beta20201201s.RedisLinkedServer) error {

	// ObjectMeta
	destination.ObjectMeta = *server.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20201201s.Redis_LinkedServer_Spec
	...
	// Status
	var status v1beta20201201s.Redis_LinkedServer_STATUS
...
func (server *Redis_LinkedServer_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20201201s.Redis_LinkedServer_Spec)
	if ok {
	...
	src = &v1beta20201201s.Redis_LinkedServer_Spec{}
...
func (server *Redis_LinkedServer_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20201201s.Redis_LinkedServer_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20201201s.Redis_LinkedServer_Spec{}
...
func (server *Redis_LinkedServer_Spec) AssignProperties_From_Redis_LinkedServer_Spec(source *v1beta20201201s.Redis_LinkedServer_Spec) error {
...
func (server *Redis_LinkedServer_Spec) AssignProperties_To_Redis_LinkedServer_Spec(destination *v1beta20201201s.Redis_LinkedServer_Spec) error {
...
func (server *Redis_LinkedServer_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20201201s.Redis_LinkedServer_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20201201s.Redis_LinkedServer_STATUS{}
...
func (server *Redis_LinkedServer_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20201201s.Redis_LinkedServer_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20201201s.Redis_LinkedServer_STATUS{}
...
func (server *Redis_LinkedServer_STATUS) AssignProperties_From_Redis_LinkedServer_STATUS(source *v1beta20201201s.Redis_LinkedServer_STATUS) error {
...
func (server *Redis_LinkedServer_STATUS) AssignProperties_To_Redis_LinkedServer_STATUS(destination *v1beta20201201s.Redis_LinkedServer_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
