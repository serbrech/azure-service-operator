...
// +kubebuilder:webhook:path=/mutate-dbforpostgresql-azure-com-v1beta20220120preview-flexibleserversfirewallrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversfirewallrules,verbs=create;update,versions=v1beta20220120preview,name=default.v1beta20220120preview.flexibleserversfirewallrules.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dbforpostgresql-azure-com-v1beta20220120preview-flexibleserversfirewallrule,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversfirewallrules,verbs=create;update,versions=v1beta20220120preview,name=validate.v1beta20220120preview.flexibleserversfirewallrules.dbforpostgresql.azure.com,admissionReviewVersions=v1
