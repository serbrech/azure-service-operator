...
func (database *FlexibleServersDatabase) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20210601s.FlexibleServersDatabase
...
func (database *FlexibleServersDatabase) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20210601s.FlexibleServersDatabase
...
func (database *FlexibleServersDatabase) AssignProperties_From_FlexibleServersDatabase(source *v1beta20210601s.FlexibleServersDatabase) error {
...
func (database *FlexibleServersDatabase) AssignProperties_To_FlexibleServersDatabase(destination *v1beta20210601s.FlexibleServersDatabase) error {

	// ObjectMeta
	destination.ObjectMeta = *database.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20210601s.FlexibleServers_Database_Spec
	...
	// Status
	var status v1beta20210601s.FlexibleServers_Database_STATUS
...
func (database *FlexibleServers_Database_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20210601s.FlexibleServers_Database_Spec)
	if ok {
	...
	src = &v1beta20210601s.FlexibleServers_Database_Spec{}
...
func (database *FlexibleServers_Database_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20210601s.FlexibleServers_Database_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20210601s.FlexibleServers_Database_Spec{}
...
func (database *FlexibleServers_Database_Spec) AssignProperties_From_FlexibleServers_Database_Spec(source *v1beta20210601s.FlexibleServers_Database_Spec) error {
...
func (database *FlexibleServers_Database_Spec) AssignProperties_To_FlexibleServers_Database_Spec(destination *v1beta20210601s.FlexibleServers_Database_Spec) error {
...
func (database *FlexibleServers_Database_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20210601s.FlexibleServers_Database_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20210601s.FlexibleServers_Database_STATUS{}
...
func (database *FlexibleServers_Database_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20210601s.FlexibleServers_Database_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20210601s.FlexibleServers_Database_STATUS{}
...
func (database *FlexibleServers_Database_STATUS) AssignProperties_From_FlexibleServers_Database_STATUS(source *v1beta20210601s.FlexibleServers_Database_STATUS) error {
...
func (database *FlexibleServers_Database_STATUS) AssignProperties_To_FlexibleServers_Database_STATUS(destination *v1beta20210601s.FlexibleServers_Database_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
