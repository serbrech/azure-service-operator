...
type augmentConversionForFlexibleServersFirewallRule interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServersFirewallRule) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServersFirewallRule) error
}

// Storage version of v1beta20210501.FlexibleServers_FirewallRule_Spec
...
// Storage version of v1beta20210501.FlexibleServers_FirewallRule_STATUS
...
type augmentConversionForFlexibleServers_FirewallRule_Spec interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServers_FirewallRule_Spec) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServers_FirewallRule_Spec) error
}

type augmentConversionForFlexibleServers_FirewallRule_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServers_FirewallRule_STATUS) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServers_FirewallRule_STATUS) error
}
