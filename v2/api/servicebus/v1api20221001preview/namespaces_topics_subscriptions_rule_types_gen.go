...
func (rule *NamespacesTopicsSubscriptionsRule) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20221001ps.NamespacesTopicsSubscriptionsRule
...
func (rule *NamespacesTopicsSubscriptionsRule) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20221001ps.NamespacesTopicsSubscriptionsRule
...
func (rule *NamespacesTopicsSubscriptionsRule) AssignProperties_From_NamespacesTopicsSubscriptionsRule(source *v20221001ps.NamespacesTopicsSubscriptionsRule) error {
...
func (rule *NamespacesTopicsSubscriptionsRule) AssignProperties_To_NamespacesTopicsSubscriptionsRule(destination *v20221001ps.NamespacesTopicsSubscriptionsRule) error {

	// ObjectMeta
	destination.ObjectMeta = *rule.ObjectMeta.DeepCopy()

	// Spec
	var spec v20221001ps.Namespaces_Topics_Subscriptions_Rule_Spec
	...
	// Status
	var status v20221001ps.Namespaces_Topics_Subscriptions_Rule_STATUS
...
func (rule *Namespaces_Topics_Subscriptions_Rule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20221001ps.Namespaces_Topics_Subscriptions_Rule_Spec)
	if ok {
	...
	src = &v20221001ps.Namespaces_Topics_Subscriptions_Rule_Spec{}
...
func (rule *Namespaces_Topics_Subscriptions_Rule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20221001ps.Namespaces_Topics_Subscriptions_Rule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20221001ps.Namespaces_Topics_Subscriptions_Rule_Spec{}
...
func (rule *Namespaces_Topics_Subscriptions_Rule_Spec) AssignProperties_From_Namespaces_Topics_Subscriptions_Rule_Spec(source *v20221001ps.Namespaces_Topics_Subscriptions_Rule_Spec) error {
...
func (rule *Namespaces_Topics_Subscriptions_Rule_Spec) AssignProperties_To_Namespaces_Topics_Subscriptions_Rule_Spec(destination *v20221001ps.Namespaces_Topics_Subscriptions_Rule_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Action
	if rule.Action != nil {
		var action v20221001ps.Action
	...
	// CorrelationFilter
	if rule.CorrelationFilter != nil {
		var correlationFilter v20221001ps.CorrelationFilter
	...
	// SqlFilter
	if rule.SqlFilter != nil {
		var sqlFilter v20221001ps.SqlFilter
...
func (rule *Namespaces_Topics_Subscriptions_Rule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20221001ps.Namespaces_Topics_Subscriptions_Rule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20221001ps.Namespaces_Topics_Subscriptions_Rule_STATUS{}
...
func (rule *Namespaces_Topics_Subscriptions_Rule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20221001ps.Namespaces_Topics_Subscriptions_Rule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20221001ps.Namespaces_Topics_Subscriptions_Rule_STATUS{}
...
func (rule *Namespaces_Topics_Subscriptions_Rule_STATUS) AssignProperties_From_Namespaces_Topics_Subscriptions_Rule_STATUS(source *v20221001ps.Namespaces_Topics_Subscriptions_Rule_STATUS) error {
...
func (rule *Namespaces_Topics_Subscriptions_Rule_STATUS) AssignProperties_To_Namespaces_Topics_Subscriptions_Rule_STATUS(destination *v20221001ps.Namespaces_Topics_Subscriptions_Rule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Action
	if rule.Action != nil {
		var action v20221001ps.Action_STATUS
	...
	// CorrelationFilter
	if rule.CorrelationFilter != nil {
		var correlationFilter v20221001ps.CorrelationFilter_STATUS
	...
	// SqlFilter
	if rule.SqlFilter != nil {
		var sqlFilter v20221001ps.SqlFilter_STATUS
...
func (action *Action) AssignProperties_From_Action(source *v20221001ps.Action) error {
...
func (action *Action) AssignProperties_To_Action(destination *v20221001ps.Action) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (action *Action_STATUS) AssignProperties_From_Action_STATUS(source *v20221001ps.Action_STATUS) error {
...
func (action *Action_STATUS) AssignProperties_To_Action_STATUS(destination *v20221001ps.Action_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (filter *CorrelationFilter) AssignProperties_From_CorrelationFilter(source *v20221001ps.CorrelationFilter) error {
...
func (filter *CorrelationFilter) AssignProperties_To_CorrelationFilter(destination *v20221001ps.CorrelationFilter) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (filter *CorrelationFilter_STATUS) AssignProperties_From_CorrelationFilter_STATUS(source *v20221001ps.CorrelationFilter_STATUS) error {
...
func (filter *CorrelationFilter_STATUS) AssignProperties_To_CorrelationFilter_STATUS(destination *v20221001ps.CorrelationFilter_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (filter *SqlFilter) AssignProperties_From_SqlFilter(source *v20221001ps.SqlFilter) error {
...
func (filter *SqlFilter) AssignProperties_To_SqlFilter(destination *v20221001ps.SqlFilter) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (filter *SqlFilter_STATUS) AssignProperties_From_SqlFilter_STATUS(source *v20221001ps.SqlFilter_STATUS) error {
...
func (filter *SqlFilter_STATUS) AssignProperties_To_SqlFilter_STATUS(destination *v20221001ps.SqlFilter_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
