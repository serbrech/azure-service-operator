...
func (namespace *Namespace) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20221001ps.Namespace
...
func (namespace *Namespace) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20221001ps.Namespace
...
func (namespace *Namespace) AssignProperties_From_Namespace(source *v20221001ps.Namespace) error {
...
func (namespace *Namespace) AssignProperties_To_Namespace(destination *v20221001ps.Namespace) error {

	// ObjectMeta
	destination.ObjectMeta = *namespace.ObjectMeta.DeepCopy()

	// Spec
	var spec v20221001ps.Namespace_Spec
	...
	// Status
	var status v20221001ps.Namespace_STATUS
...
func (namespace *Namespace_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if namespace.MinimumTlsVersion != nil {
		minimumTlsVersion := *namespace.MinimumTlsVersion
	...
	if namespace.PublicNetworkAccess != nil {
		publicNetworkAccess := *namespace.PublicNetworkAccess
...
func (namespace *Namespace_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20221001ps.Namespace_Spec)
	if ok {
	...
	src = &v20221001ps.Namespace_Spec{}
...
func (namespace *Namespace_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20221001ps.Namespace_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20221001ps.Namespace_Spec{}
...
func (namespace *Namespace_Spec) AssignProperties_From_Namespace_Spec(source *v20221001ps.Namespace_Spec) error {
...
func (namespace *Namespace_Spec) AssignProperties_To_Namespace_Spec(destination *v20221001ps.Namespace_Spec) error {
	...
	// Encryption
	if namespace.Encryption != nil {
		var encryption v20221001ps.Encryption
	...
	// Identity
	if namespace.Identity != nil {
		var identity v20221001ps.Identity
	...
	if namespace.OperatorSpec != nil {
		var operatorSpec v20221001ps.NamespaceOperatorSpec
...
func (namespace *Namespace_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20221001ps.Namespace_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20221001ps.Namespace_STATUS{}
...
func (namespace *Namespace_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20221001ps.Namespace_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20221001ps.Namespace_STATUS{}
...
func (namespace *Namespace_STATUS) AssignProperties_From_Namespace_STATUS(source *v20221001ps.Namespace_STATUS) error {
...
func (namespace *Namespace_STATUS) AssignProperties_To_Namespace_STATUS(destination *v20221001ps.Namespace_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Encryption
	if namespace.Encryption != nil {
		var encryption v20221001ps.Encryption_STATUS
	...
	// Identity
	if namespace.Identity != nil {
		var identity v20221001ps.Identity_STATUS
	...
	if namespace.PrivateEndpointConnections != nil {
		privateEndpointConnectionList := make([]v20221001ps.PrivateEndpointConnection_STATUS, len(namespace.PrivateEndpointConnections))
		for privateEndpointConnectionIndex, privateEndpointConnectionItem := range namespace.PrivateEndpointConnections {
			// Shadow the loop variable to avoid aliasing
			privateEndpointConnectionItem := privateEndpointConnectionItem
			var privateEndpointConnection v20221001ps.PrivateEndpointConnection_STATUS
	...
	// Sku
	if namespace.Sku != nil {
		var sku v20221001ps.SBSku_STATUS
...
func (encryption *Encryption) AssignProperties_From_Encryption(source *v20221001ps.Encryption) error {
...
func (encryption *Encryption) AssignProperties_To_Encryption(destination *v20221001ps.Encryption) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if encryption.KeyVaultProperties != nil {
		keyVaultPropertyList := make([]v20221001ps.KeyVaultProperties, len(encryption.KeyVaultProperties))
...
func (encryption *Encryption_STATUS) AssignProperties_From_Encryption_STATUS(source *v20221001ps.Encryption_STATUS) error {
...
func (encryption *Encryption_STATUS) AssignProperties_To_Encryption_STATUS(destination *v20221001ps.Encryption_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// KeyVaultProperties
	if encryption.KeyVaultProperties != nil {
		keyVaultPropertyList := make([]v20221001ps.KeyVaultProperties_STATUS, len(encryption.KeyVaultProperties))
		for keyVaultPropertyIndex, keyVaultPropertyItem := range encryption.KeyVaultProperties {
			// Shadow the loop variable to avoid aliasing
			keyVaultPropertyItem := keyVaultPropertyItem
...
func (identity *Identity) AssignProperties_From_Identity(source *v20221001ps.Identity) error {
...
func (identity *Identity) AssignProperties_To_Identity(destination *v20221001ps.Identity) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20221001ps.UserAssignedIdentityDetails, len(identity.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v20221001ps.UserAssignedIdentityDetails
...
func (identity *Identity_STATUS) AssignProperties_From_Identity_STATUS(source *v20221001ps.Identity_STATUS) error {
...
func (identity *Identity_STATUS) AssignProperties_To_Identity_STATUS(destination *v20221001ps.Identity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// UserAssignedIdentities
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20221001ps.UserAssignedIdentity_STATUS, len(identity.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v20221001ps.UserAssignedIdentity_STATUS
...
func (operator *NamespaceOperatorSpec) AssignProperties_From_NamespaceOperatorSpec(source *v20221001ps.NamespaceOperatorSpec) error {
...
func (operator *NamespaceOperatorSpec) AssignProperties_To_NamespaceOperatorSpec(destination *v20221001ps.NamespaceOperatorSpec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Secrets
	if operator.Secrets != nil {
		var secret v20221001ps.NamespaceOperatorSecrets
...
func (connection *PrivateEndpointConnection_STATUS) AssignProperties_From_PrivateEndpointConnection_STATUS(source *v20221001ps.PrivateEndpointConnection_STATUS) error {
...
func (connection *PrivateEndpointConnection_STATUS) AssignProperties_To_PrivateEndpointConnection_STATUS(destination *v20221001ps.PrivateEndpointConnection_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sbSku *SBSku) AssignProperties_From_SBSku(source *v20221001ps.SBSku) error {
...
func (sbSku *SBSku) AssignProperties_To_SBSku(destination *v20221001ps.SBSku) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sbSku *SBSku_STATUS) AssignProperties_From_SBSku_STATUS(source *v20221001ps.SBSku_STATUS) error {
...
func (sbSku *SBSku_STATUS) AssignProperties_To_SBSku_STATUS(destination *v20221001ps.SBSku_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v20221001ps.SystemData_STATUS) error {
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v20221001ps.SystemData_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *KeyVaultProperties) AssignProperties_From_KeyVaultProperties(source *v20221001ps.KeyVaultProperties) error {
...
func (properties *KeyVaultProperties) AssignProperties_To_KeyVaultProperties(destination *v20221001ps.KeyVaultProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Identity
	if properties.Identity != nil {
		var identity v20221001ps.UserAssignedIdentityProperties
...
func (properties *KeyVaultProperties_STATUS) AssignProperties_From_KeyVaultProperties_STATUS(source *v20221001ps.KeyVaultProperties_STATUS) error {
...
func (properties *KeyVaultProperties_STATUS) AssignProperties_To_KeyVaultProperties_STATUS(destination *v20221001ps.KeyVaultProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Identity
	if properties.Identity != nil {
		var identity v20221001ps.UserAssignedIdentityProperties_STATUS
...
func (secrets *NamespaceOperatorSecrets) AssignProperties_From_NamespaceOperatorSecrets(source *v20221001ps.NamespaceOperatorSecrets) error {
...
func (secrets *NamespaceOperatorSecrets) AssignProperties_To_NamespaceOperatorSecrets(destination *v20221001ps.NamespaceOperatorSecrets) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_From_UserAssignedIdentity_STATUS(source *v20221001ps.UserAssignedIdentity_STATUS) error {
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_To_UserAssignedIdentity_STATUS(destination *v20221001ps.UserAssignedIdentity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v20221001ps.UserAssignedIdentityDetails) error {
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v20221001ps.UserAssignedIdentityDetails) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *UserAssignedIdentityProperties) AssignProperties_From_UserAssignedIdentityProperties(source *v20221001ps.UserAssignedIdentityProperties) error {
...
func (properties *UserAssignedIdentityProperties) AssignProperties_To_UserAssignedIdentityProperties(destination *v20221001ps.UserAssignedIdentityProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *UserAssignedIdentityProperties_STATUS) AssignProperties_From_UserAssignedIdentityProperties_STATUS(source *v20221001ps.UserAssignedIdentityProperties_STATUS) error {
...
func (properties *UserAssignedIdentityProperties_STATUS) AssignProperties_To_UserAssignedIdentityProperties_STATUS(destination *v20221001ps.UserAssignedIdentityProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
