...
type augmentConversionForVault interface {
	AssignPropertiesFrom(src *v20210401ps.Vault) error
	AssignPropertiesTo(dst *v20210401ps.Vault) error
}
...
type augmentConversionForVault_Spec interface {
	AssignPropertiesFrom(src *v20210401ps.Vault_Spec) error
	AssignPropertiesTo(dst *v20210401ps.Vault_Spec) error
}

type augmentConversionForVault_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.Vault_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.Vault_STATUS) error
}
...
type augmentConversionForSystemData_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.SystemData_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.SystemData_STATUS) error
}

type augmentConversionForVaultProperties interface {
	AssignPropertiesFrom(src *v20210401ps.VaultProperties) error
	AssignPropertiesTo(dst *v20210401ps.VaultProperties) error
}

type augmentConversionForVaultProperties_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.VaultProperties_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.VaultProperties_STATUS) error
}
...
type augmentConversionForAccessPolicyEntry interface {
	AssignPropertiesFrom(src *v20210401ps.AccessPolicyEntry) error
	AssignPropertiesTo(dst *v20210401ps.AccessPolicyEntry) error
}

type augmentConversionForAccessPolicyEntry_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.AccessPolicyEntry_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.AccessPolicyEntry_STATUS) error
}

type augmentConversionForNetworkRuleSet interface {
	AssignPropertiesFrom(src *v20210401ps.NetworkRuleSet) error
	AssignPropertiesTo(dst *v20210401ps.NetworkRuleSet) error
}

type augmentConversionForNetworkRuleSet_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.NetworkRuleSet_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.NetworkRuleSet_STATUS) error
}

type augmentConversionForPrivateEndpointConnectionItem_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.PrivateEndpointConnectionItem_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.PrivateEndpointConnectionItem_STATUS) error
}

type augmentConversionForSku interface {
	AssignPropertiesFrom(src *v20210401ps.Sku) error
	AssignPropertiesTo(dst *v20210401ps.Sku) error
}

type augmentConversionForSku_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.Sku_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.Sku_STATUS) error
}
...
type augmentConversionForIPRule interface {
	AssignPropertiesFrom(src *v20210401ps.IPRule) error
	AssignPropertiesTo(dst *v20210401ps.IPRule) error
}

type augmentConversionForIPRule_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.IPRule_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.IPRule_STATUS) error
}

type augmentConversionForPermissions interface {
	AssignPropertiesFrom(src *v20210401ps.Permissions) error
	AssignPropertiesTo(dst *v20210401ps.Permissions) error
}

type augmentConversionForPermissions_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.Permissions_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.Permissions_STATUS) error
}

type augmentConversionForPrivateEndpoint_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.PrivateEndpoint_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.PrivateEndpoint_STATUS) error
}

type augmentConversionForPrivateLinkServiceConnectionState_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.PrivateLinkServiceConnectionState_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.PrivateLinkServiceConnectionState_STATUS) error
}

type augmentConversionForVirtualNetworkRule interface {
	AssignPropertiesFrom(src *v20210401ps.VirtualNetworkRule) error
	AssignPropertiesTo(dst *v20210401ps.VirtualNetworkRule) error
}

type augmentConversionForVirtualNetworkRule_STATUS interface {
	AssignPropertiesFrom(src *v20210401ps.VirtualNetworkRule_STATUS) error
	AssignPropertiesTo(dst *v20210401ps.VirtualNetworkRule_STATUS) error
}
